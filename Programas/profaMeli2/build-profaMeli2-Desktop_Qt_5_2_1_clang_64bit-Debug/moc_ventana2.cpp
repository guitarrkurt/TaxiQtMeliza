...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_ventana2_t, stringdata) + ofs \
...
const QMetaObject ventana2::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_ventana2.data,
      qt_meta_data_ventana2,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_ventana2.stringdata))
